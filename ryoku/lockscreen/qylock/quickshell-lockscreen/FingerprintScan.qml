...
// MIRROR of the canonical ryoku/ui/FingerprintScan.qml (Ryoku.Ui). This bundle
// is standalone/offline and cannot import Ryoku.Ui, so it vendors its own copy
// (as it does for SddmComponents). Keep the body in sync with the canonical.
//
